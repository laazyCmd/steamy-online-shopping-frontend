<nav class="relative bg-[#171A21] text-white h-[136px]">
    ...
    <header class="flex justify-around items-center mx-auto max-w-[1077px]">
        <!-- navigation links/buttons -->
        <section class="absolute bottom-0 flex gap-x-8 text-xl self-end mr-[53px] mb-[11px]">
